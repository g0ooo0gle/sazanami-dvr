...
現在の安定版はv1.3.1です。配布ファイルは[GitHub Releases](https://github.com/g0ooo0gle/sazanami-dvr/releases)で確認できます。
...
[Linuxへインストールする](https://github.com/g0ooo0gle/sazanami-dvr/blob/v1.3.1/docs/getting-started/linux.md)

## Compose

Sazanami DVRとKonomiTVを同じLinuxホストで起動する最小構成を用意しています。

[Docker Composeで起動する](https://github.com/g0ooo0gle/sazanami-dvr/blob/v1.3.1/docs/getting-started/docker-compose.md)

## KonomiTV

KonomiTVのバックエンドをEDCBに設定し、CtrlCmdの接続先をSazanami DVRへ向けます。

[KonomiTVを接続する](https://github.com/g0ooo0gle/sazanami-dvr/blob/v1.3.1/docs/getting-started/konomitv.md)
...
導入後の操作、設定、更新、復旧、トラブル対応は[ドキュメント一覧](https://github.com/g0ooo0gle/sazanami-dvr/blob/v1.3.1/docs/README.md)から探せます。

開発への参加は[CONTRIBUTING.md](https://github.com/g0ooo0gle/sazanami-dvr/blob/v1.3.1/CONTRIBUTING.md)、脆弱性の連絡は[SECURITY.md](https://github.com/g0ooo0gle/sazanami-dvr/blob/v1.3.1/SECURITY.md)を参照してください。
